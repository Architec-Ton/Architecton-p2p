...
import {Order, Request} from '../wrappers/Order';
...
describe('Order', () => {
    ...
    beforeEach(async () => {
        ...
        const sellJettonWalletDeployer = blockchain.openContract(
        ...
        const buyJettonWalletDeployer = blockchain.openContract(
            Wallet.createFromConfig(
    ...
    it('main flow', async () => {
        ...
        order = blockchain.openContract(await Order.fromInit(seller.address, request));
